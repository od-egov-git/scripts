-- Duplicate Demand Details Deletion Query For Bhubaneswar--
...
from egbs_demand_v1 edv where businessservice='WS' and tenantid ='od.bhubaneswar'
order by consumercode, date(to_timestamp(taxperiodfrom/1000)), date(to_timestamp(taxperiodto/1000)), createdtime)
and businessservice ='WS' and tenantid ='od.bhubaneswar');
